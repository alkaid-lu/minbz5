...
def train(model, data_loader, optimzizer, epochs, scheduler):
    ...
    torch.save(checkpoint, 'model1214.pth.tar')
...
if __name__ == '__main__':
    ...
    dataset = Monecular('remove_N_char_data.csv', max_length=args.smile_length)
    train_ratio = 0.95
    ...
    test_loader = DataLoader(test_dataset, batch_size=5000, num_workers=5)
